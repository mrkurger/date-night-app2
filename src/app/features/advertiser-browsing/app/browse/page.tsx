...
const advertisers = [
  {
    ...
    description: "Professional dancer with 5 years of experience. Specializing in private performances.",
  ...
  },
  {
    ...
    description: "Experienced massage therapist specializing in deep tissue and relaxation techniques.",
...
export default function BrowsePage() {
  const [activeView, setActiveView] = useState<"grid" | "cards" | "map" | "nearby" | "featured">("grid")
        ...
        <div className="flex flex-col lg:flex-row gap-6">
          <div className="flex-1">
            ...
            {(!isSearching || (isSearching && displayedAdvertisers.some((ad) => ad.isPremium))) && (
              <PremiumAdsSection
                premiumAds={isSearching ? displayedAdvertisers.filter((ad) => ad.isPremium) : premiumAds}
              />
            )}
