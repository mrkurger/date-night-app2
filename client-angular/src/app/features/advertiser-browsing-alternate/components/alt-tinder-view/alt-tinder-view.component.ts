...
export class AltTinderViewComponent implements OnInit {
  ...
  @Output() nope = new EventEmitter<Advertiser>();
  @Output() info = new EventEmitter<Advertiser>();
  @Output() refresh = new EventEmitter<void>();
  @Output() superlike = new EventEmitter<Advertiser>();
  @Output() rewind = new EventEmitter<void>();
  @Output() boost = new EventEmitter<void>();
  ...
  private moveToNextCard() {
    if (this.currentIndex < this.advertisers.length - 1) {
      this.currentIndex++;
      this.updateVisibleCards();
      // Reset states
      this.dragX = 0;
