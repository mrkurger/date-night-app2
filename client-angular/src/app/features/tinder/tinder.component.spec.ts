...
describe('TinderComponent', () => {
  ...
  const mockAds = [
    ...
    },
    {
      ...
      category: 'Activity',
      media: [
        { url: '/assets/images/test-image-2.jpg', type: 'image' }
      ],
  ...
  describe('initialization', () => {
    ...
    it('should handle error when loading ads', fakeAsync(() => {
      spyOn(adService, 'getSwipeAds').and.returnValue(throwError(() => new Error('Failed to load ads')));
  ...
  describe('error handling', () => {
    it('should handle error when recording swipe', fakeAsync(() => {
      spyOn(adService, 'recordSwipe').and.returnValue(throwError(() => new Error('Failed to record swipe')));
      spyOn(console, 'error');
    ...
    it('should handle error when starting chat', () => {
      spyOn(chatService, 'createAdRoom').and.returnValue(throwError(() => new Error('Failed to create chat room')));
