...
// ===================================================
import { Component, OnInit, OnDestroy, ViewChild, ElementRef, TemplateRef, AfterViewChecked } from '@angular/core';
...
export class ChatComponent implements OnInit, OnDestroy, AfterViewChecked {
  ...
  constructor(
    ...
    const typingSub = this.typingSubject.pipe(
      debounceTime(TYPING_INDICATOR_DELAY),
  ...
  transformMessages(messages: any[]): ChatMessage[] {
    return messages.map(msg => {
      ...
      if (typeof msg.sender === 'string') {
        ...
        const senderAsObj = msg.sender as any;
        senderObj = {
          id: senderAsObj.id || 'unknown',
          username: senderAsObj.username || this.getContactById(senderAsObj.id)?.name || 'Unknown User'
        };
      }
      ...
      if (msg.recipient) {
        if (typeof msg.recipient === 'string') {
          ...
          const recipientAsObj = msg.recipient as any;
          recipientObj = {
            id: recipientAsObj.id || 'unknown',
            username: recipientAsObj.username || this.getContactById(recipientAsObj.id)?.name || 'Unknown Recipient'
          };
        }
      }
  ...
  groupMessagesByDate(): void {
    ...
    this.messageGroups = Object.values(groups).sort((a, b) => 
  ...
  private createDummyMessages(contact: Contact): void {
    ...
    this.messages = [
      ...
      },
      {
        ...
        message: 'I was thinking of trying the new trail at Mount Rainier. It\'s supposed to have amazing views!',
      ...
      },
      {
        ...
        message: 'Here\'s the trail map I used: https://www.alltrails.com/trail/us/washington/mount-rainier',
      ...
      },
      {
        ...
        message: 'Thanks! This is super helpful. I\'ll check it out and let you know if I have any questions.',
