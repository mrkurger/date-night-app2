...
describe('AppComponent', () => {
  ...
  let mockChatService: jasmine.SpyObj;
  let mockCsrfService: jasmine.SpyObj;
  let mockPlatformService: jasmine.SpyObj;
  let mockPwaService: jasmine.SpyObj;
  let mockThemeService: jasmine.SpyObj;
  let mockTitleService: jasmine.SpyObj;
  let mockMetaService: jasmine.SpyObj;
  let router: Router;
  ...
  beforeEach(async () => {
    ...
    @Component({
      selector: 'app-root',
      template: 'Mock App Component', // Simple template without aria-label attributes
      standalone: true
    })
