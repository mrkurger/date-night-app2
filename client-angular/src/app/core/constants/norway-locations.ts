...
export const NORWAY_COUNTIES: NorwayCounty[] = [
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'Jessheim', coordinates: [11.1704, 60.1410] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'Kongsvinger', coordinates: [12.0050, 60.1918] },
      { name: 'Brumunddal', coordinates: [10.9334, 60.8793] },
      { name: 'Moelv', coordinates: [10.7000, 60.9333] },
      { name: 'Raufoss', coordinates: [10.6167, 60.7333] },
      { name: 'Otta', coordinates: [9.5333, 61.7667] },
      { name: 'Vinstra', coordinates: [9.7500, 61.5833] }
    ]
  },
  {
    ...
    cities: [
      ...
      { name: 'Larvik', coordinates: [10.0333, 59.0500] },
      { name: 'Skien', coordinates: [9.6100, 59.2100] },
      { name: 'Porsgrunn', coordinates: [9.6561, 59.1408] },
      { name: 'Horten', coordinates: [10.4833, 59.4167] },
      { name: 'Notodden', coordinates: [9.2500, 59.5667] },
      { name: 'Kragerø', coordinates: [9.4167, 58.8667] },
      { name: 'Stokke', coordinates: [10.3000, 59.2333] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: 'Mandal', coordinates: [7.4500, 58.0333] },
      { name: 'Flekkefjord', coordinates: [6.6667, 58.3000] },
      { name: 'Lillesand', coordinates: [8.3833, 58.2500] },
      { name: 'Risør', coordinates: [9.2333, 58.7167] },
      { name: 'Tvedestrand', coordinates: [8.9333, 58.6167] },
      { name: 'Farsund', coordinates: [6.8000, 58.0833] },
  ...
  },
  {
    name: 'Rogaland',
    cities: [
      { name: 'Stavanger', coordinates: [5.7331, 58.9700] },
      { name: 'Sandnes', coordinates: [5.7333, 58.8500] },
      { name: 'Haugesund', coordinates: [5.2667, 59.4167] },
      { name: 'Egersund', coordinates: [5.9900, 58.4500] },
      { name: 'Bryne', coordinates: [5.6500, 58.7333] },
      { name: 'Kopervik', coordinates: [5.3000, 59.2833] },
      { name: 'Åkrehamn', coordinates: [5.1833, 59.2500] },
      { name: 'Sauda', coordinates: [6.3500, 59.6500] },
  ...
  },
  {
    name: 'Vestland',
    cities: [
      { name: 'Bergen', coordinates: [5.3220, 60.3913] },
      { name: 'Førde', coordinates: [5.8500, 61.4500] },
      { name: 'Florø', coordinates: [5.0333, 61.6000] },
      { name: 'Sogndal', coordinates: [7.1000, 61.2333] },
      { name: 'Voss', coordinates: [6.4167, 60.6333] },
      { name: 'Odda', coordinates: [6.5500, 60.0667] },
      { name: 'Leirvik', coordinates: [5.5000, 59.7833] },
      { name: 'Askøy', coordinates: [5.2000, 60.4667] },
      { name: 'Knarvik', coordinates: [5.2833, 60.5500] },
  ...
  },
  {
    ...
    cities: [
      { name: 'Ålesund', coordinates: [6.1500, 62.4667] },
      { name: 'Molde', coordinates: [7.1600, 62.7375] },
      { name: 'Kristiansund', coordinates: [7.7333, 63.1167] },
      { name: 'Ulsteinvik', coordinates: [5.8833, 62.3333] },
      { name: 'Volda', coordinates: [6.0667, 62.1500] },
      { name: 'Ørsta', coordinates: [6.1333, 62.2000] },
      { name: 'Sunndalsøra', coordinates: [8.5500, 62.6667] },
      { name: 'Spjelkavik', coordinates: [6.3333, 62.4500] },
      { name: 'Åndalsnes', coordinates: [7.6833, 62.5667] },
      { name: 'Stranda', coordinates: [6.9500, 62.3000] }
    ]
  },
  {
    name: 'Trøndelag',
    cities: [
      ...
      { name: 'Steinkjer', coordinates: [11.5000, 64.0167] },
      { name: 'Stjørdalshalsen', coordinates: [11.1667, 63.4667] },
      { name: 'Levanger', coordinates: [11.3000, 63.7500] },
      { name: 'Namsos', coordinates: [11.5000, 64.4667] },
      { name: 'Verdalsøra', coordinates: [11.5000, 63.8000] },
      { name: 'Orkanger', coordinates: [9.8500, 63.3000] },
      { name: 'Røros', coordinates: [11.3833, 62.5833] },
      { name: 'Brekstad', coordinates: [10.0000, 63.6833] },
      { name: 'Oppdal', coordinates: [9.6833, 62.6000] }
    ]
  },
  {
    name: 'Nordland',
    cities: [
      ...
      { name: 'Leknes', coordinates: [13.6167, 68.1500] },
      { name: 'Svolvær', coordinates: [14.5667, 68.2333] },
      { name: 'Sortland', coordinates: [15.4167, 68.7000] }
    ]
  },
  {
    ...
    cities: [
      ...
      { name: 'Harstad', coordinates: [16.5333, 68.8000] },
...
export const getAllCounties = (): string[] => {
  return NORWAY_COUNTIES.map(county => county.name);
};
...
export const getAllCities = (): string[] => {
  return NORWAY_COUNTIES.flatMap(county => county.cities.map(city => city.name));
};
...
export const getCountyByCity = (cityName: string): string | null => {
  const county = NORWAY_COUNTIES.find(c => 
    c.cities.some(city => city.name === cityName)
  );
