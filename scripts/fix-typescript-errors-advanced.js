...
async function main() {
  ...
  for (const [filePath, fileErrors] of Object.entries(errorsByFile)) {
    ...
    for (const error of fileErrors) {
      try {
        const fixed = fixError(sourceFile, error);
...
function fixExportNameError(sourceFile, error) {
...
function fixMissingPropertyError(sourceFile, error) {
...
function fixTypeAssignmentError(sourceFile, error) {
...
function fixTypeComparisonError(sourceFile, error) {
...
function fixPropertyNameError(sourceFile, error) {
...
function fixObjectLiteralError(sourceFile, error) {
...
function fixArgumentTypeError(sourceFile, error) {
