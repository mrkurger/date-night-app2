...
import { getProfileImage, getFemaleImageByIndex } from '@/lib/data';
...
const mockAdvertisers: Advertiser[] = [
  {
    ...
    location: 'Stockholm',
    distance: 2,
    images: [getFemaleImageByIndex(1)],
    rating: 4.9,
  ...
  },
  {
    ...
    location: 'Gothenburg',
    distance: 5,
    images: [getFemaleImageByIndex(2)],
    rating: 4.8,
    tags: ['Dance', 'Entertainment', 'VIP'],
    description:
      'Professional dancer and entertainer. Available for private events and performances.',
    isVip: false,
    isOnline: false,
  },
  {
    ...
    location: 'Malmö',
    distance: 3,
    images: [getFemaleImageByIndex(3)],
    rating: 4.7,
...
const sponsoredAdvertisers: Advertiser[] = [
  {
    ...
    location: 'Uppsala',
    distance: 7,
    images: [getFemaleImageByIndex(4)],
    rating: 4.6,
  ...
  },
  {
    ...
    location: 'Stockholm',
    distance: 4,
    images: [getFemaleImageByIndex(5)],
    rating: 4.5,
  ...
  },
  {
    ...
    location: 'Gothenburg',
    distance: 6,
    images: [getFemaleImageByIndex(6)],
    rating: 4.4,
    tags: ['Dance', 'VIP'],
    isVip: true,
    isOnline: true,
            ...
            >
              ...
              <div className="card-tags flex flex-wrap gap-2 mb-6">
                {currentAdvertiser.tags.map((tag, index) => (
                  <span
                    key={index}
                    className="tag bg-white/20 px-3 py-1 rounded-full text-sm backdrop-blur-sm"
                  >
                    {tag}
                  </span>
                ))}
                    ...
                    <ul className="space-y-2">
                      {(currentAdvertiser.services || defaultServices).map((service, index) => (
                        ...
                        >
                          ...
                          <span className="service-price text-green-400 font-medium">
                            {service.price}
                          </span>
                        </li>
                      ))}
