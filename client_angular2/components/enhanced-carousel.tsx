...
export function EnhancedCarousel({ advertisers, title, className, variant = "default" }: EnhancedCarouselProps) {
        ...
        >
          {advertisers.map((advertiser) => (
            ...
            >
              {/* Card Image */}
              <img
                src={advertiser.image || `/placeholder.svg?height=450&width=350&text=${advertiser.name}`}
                alt={advertiser.name}
                  ...
                  {showInfo === advertiser.id && (
                    ...
                    >
                      <div>
                        ...
                        {advertiser.location && <p className="text-white/80 mb-4">{advertiser.location}</p>}
