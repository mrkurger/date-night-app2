        ...
        <div className="absolute top-1/4 left-1/2 transform -translate-x-1/2 z-20">
          <Card className="bg-black/90 backdrop-blur-sm border-yellow-500/50 p-4 animate-pulse">
            <div className="text-center">
              <div className="text-yellow-400 font-bold text-lg mb-2">🎰 {currentGame.toUpperCase()} GAME ACTIVE!</div>
              <div className="text-white text-sm mb-3">Tips get {gameMultiplier}x multiplier during this game!</div>
              <div className="flex gap-2">
                <Button
                  size="sm"
      ...
      <div className="absolute bottom-4 left-4 right-4 z-20">
        <Card className="bg-black/90 backdrop-blur-sm border-pink-500/30 p-4">
          <div className="flex items-center justify-between mb-3">
            ...
            <div className="flex gap-2">
              <Button size="sm" className="bg-green-600 hover:bg-green-700" onClick={() => handleGameTip(10)}>
                <DollarSign className="w-4 h-4 mr-1" />
                $10
              </Button>
              <Button size="sm" className="bg-purple-600 hover:bg-purple-700" onClick={() => handleGameTip(25)}>
          ...
          {showGameOverlay && (
            <div className="border-t border-gray-700 pt-3 mt-3">
              <div className="grid grid-cols-2 md:grid-cols-4 gap-2">
                <Button size="sm" className="bg-blue-600 hover:bg-blue-700" onClick={() => onTipWithGame(50, "keno")}>
                  <Dice1 className="w-4 h-4 mr-1" />
                  Keno
                </Button>
                <Button
