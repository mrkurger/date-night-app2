...
exports.validateItineraryData = [
  ...
  body('arrivalDate')
    ...
    .isISO8601().withMessage('Arrival date must be a valid date')
    .custom((value, { req }) => {
  ...
  body('accommodation.showAccommodation')
    .optional()
    .isBoolean().withMessage('showAccommodation must be a boolean'),
  ...
  body('accommodation.address')
    .optional()
    .isString().withMessage('Accommodation address must be a string')
    .trim(),
...
exports.validateLocationQuery = [
  ...
  query('distance')
    .optional()
    .isInt({ min: 1, max: 100000 }).withMessage('Distance must be between 1 and 100000 meters'),
...
exports.validateAdId = [
  param('adId')
    .notEmpty().withMessage('Ad ID is required')
    .isMongoId().withMessage('Invalid Ad ID format'),
...
exports.validateItineraryId = [
  param('itineraryId')
    ...
    .isString().withMessage('Invalid Itinerary ID format'),
