...
describe('Security Headers Middleware', () => {
  ...
  beforeEach(() => {
    req = mockRequest({
      path: '/some/path', // Add a default path
    });
    res = mockResponse();
    // Add setHeader method to mock response
  ...
  it('should set Strict-Transport-Security header in production', () => {
    ...
    // Set to production to trigger the HSTS header
  ...
  it('should set Cache-Control header for auth routes', () => {
  ...
  it('should set all required security headers', () => {
    // Set to production to trigger all headers
    const originalNodeEnv = process.env.NODE_ENV;
    process.env.NODE_ENV = 'production';
