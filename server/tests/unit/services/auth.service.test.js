...
describe('Auth Service', () => {
  ...
  describe('validateRefreshToken', () => {
    ...
    it('should throw an error if user is not found', async () => {
      ...
      await expect(authService.validateRefreshToken('valid_refresh_token'))
    ...
    it('should throw an error if token is invalid', async () => {
      ...
      await expect(authService.validateRefreshToken('invalid_refresh_token'))
  ...
  describe('authenticate', () => {
    ...
    it('should throw an error if user is not found', async () => {
      ...
      await expect(authService.authenticate('nonexistent@example.com', 'Password123!'))
        .rejects.toThrow('User not found');
    });
    ...
    it('should throw an error if password is invalid', async () => {
      ...
      await expect(authService.authenticate('test@example.com', 'WrongPassword123!'))
  ...
  describe('validateAccessToken', () => {
    ...
    it('should throw an error if user is not found', async () => {
      ...
      await expect(authService.validateAccessToken('valid_access_token'))
    ...
    it('should throw an error if token is invalid', async () => {
      ...
      await expect(authService.validateAccessToken('invalid_access_token'))
        .rejects.toThrow('Invalid access token');
    });
  });
