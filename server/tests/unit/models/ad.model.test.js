...
describe('Ad Model', () => {
  ...
  describe('Ad Static Methods', () => {
    ...
    it('should find active ads', async () => {
      ...
      for (const ad of activeAds) {
        ...
        expect(ad.expiresAt).toBeGreaterThan(new Date());
      }
    });
  ...
  describe('Travel Itinerary Methods', () => {
    ...
    it('should add a travel itinerary', async () => {
      ...
      expect(itinerary.destination.location.coordinates).toEqual(itineraryData.destination.location.coordinates);
    ...
    it('should update a travel itinerary', async () => {
      ...
      expect(updatedItinerary.destination.location.coordinates).toEqual(updates.destination.location.coordinates);
    ...
    it('should throw an error when updating a non-existent itinerary', async () => {
      ...
      await expect(testAd.updateTravelItinerary(nonExistentId, updates))
    ...
    it('should throw an error when cancelling a non-existent itinerary', async () => {
      ...
      await expect(testAd.cancelTravelItinerary(nonExistentId))
        .rejects.toThrow('Itinerary not found');
    });
  });
});