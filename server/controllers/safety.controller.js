...
// ===================================================
// This file contains settings for safety.controller settings
//
...
exports.getSafetyCheckin = async (req, res) => {
  try {
    ...
    const checkin = await SafetyCheckin.findById(checkinId).populate(
      'meetingWith',
...
exports.verifyWithSafetyCode = async (req, res) => {
  try {
    ...
    const checkin = await SafetyCheckin.findById(checkinId).select('+safetyCode +distressCode');
